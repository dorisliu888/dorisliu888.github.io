        ...
        <div class="listing-item">
            ...
            <ul class="list-inline listing-tags m-0">
                <li class="list-inline-item"><a class="reset-anchor font-weight-normal text-gray text-small"
                    href="${
                      project.link ? project.link : project.path + ".pdf"
                    }">${project.type}</a></li>
            </ul><a class="reset-anchor d-block listing-img-holder" href="${
              project.link ? project.link : project.path + ".pdf"
            }"><img
                class="img-fluid" src="${project.path}.PNG" alt="${
  project.title
}" height="400">
            ...
            <div class="py-3"><a class="reset-anchor" href="${
              project.link ? project.link : project.path + ".pdf"
            }">
